...
export default function Process() {
  return (
    <section className="cv-auto py-32 bg-black text-white px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-zinc-800 before:to-transparent">
          {steps.map((step, index) => (
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full border border-zinc-700 bg-zinc-950 text-zinc-300 font-bold text-sm shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                {step.id}
              </div>
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] bg-zinc-950 border border-zinc-900 p-6 md:p-8 rounded-2xl">
